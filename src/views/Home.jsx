    ...
    <section className="flex flex-col items-center justify-center w-full lg:h-screen h-[100dvh] md:p-0 p-4 bg-[radial-gradient(circle,_#f7f9fa_50%,_#040d0e_100%)] animate-fadeInFast">
      ...
      {showButton && (
        <button
          ...
          className="absolute text-bold border-y border-[#575d5e] active:border-white lg:w-[15%] sm:w-[20%] w-[50%] left-0 top-5 pl-4 pr-8 py-4 hover:bg-[#061617] animate-fadeIn bg-[#061112] text-white rounded-r-full transition-all"
        >
          About
        </button>
      )}
      {showButton && (
        <button
          ...
          className="absolute text-bold border-y border-[#575d5e] active:border-white lg:w-[15%] sm:w-[20%] w-[50%] right-0 bottom-24 pl-8 pr-4 py-4 hover:bg-[#061617] animate-fadeIn bg-[#061112] text-white rounded-l-full transition-all"
        >
          Projects
        </button>
      )}
      {showButton && (
        <button
          ...
          className="absolute text-bold border-y border-[#575d5e] active:border-white lg:w-[15%] sm:w-[20%] w-[50%] right-0 bottom-5 pl-8 pr-4 py-4 hover:bg-[#061617] animate-fadeIn bg-[#061112] text-white rounded-l-full transition-all"
        >
          Contact
        </button>
      )}
